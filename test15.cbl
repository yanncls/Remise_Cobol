      ...
      *    Ligne 3
       01  WS-LIGNE3.
           ...
           'Vous �tes clients depuis plus de '.
           05  WS-ANNEED       PIC 9.
      ...
      *    Ligne 3A
       01  WS-LIGNE3A.
           ...
           'Vous �tes clients depuis moins d''un'.
           05  FILLER          PIC X(24)   VALUE
           ' an et � l''ocasion de '.
      ...
      *---------------------------------------------------------------*
           DISPLAY '***********1000-DEB***********'
      *    Pr�paration des donn�es clients
      ...
      *SI COMPETEUR COMMANDE DIFFERENT DE 0
           ...
           END-IF.
      *SINON
      *    pas de remise si aucune condition respect�e
      ...
      *---------------------------------------------------------------*
      *    �criture fichier FICERRO (commande sans compte client)
           DISPLAY '***********2020-FIN***********'
      ...
      *SI
      *    commande pass�e date -24 mois et premiere commande
      ...
      *SI
      *    commande pass�e date -24 mois et commande suivante
